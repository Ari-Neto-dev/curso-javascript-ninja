...
console.log(text.replace(/Manuel Marques de Sousa?/,'Ariosvaldo de Azevedo Neto'));
...
//
console.log(text.replace(/O Centauro de Luvas/g, function(phrase){return phrase.toUpperCase();}));
